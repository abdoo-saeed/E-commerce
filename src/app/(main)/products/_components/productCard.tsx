...
export default function ProductCard({ product }: { product: Iproduct }) {
  ...
  return (
    <div className="group max-w-xs sm:max-w-sm bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 p-4 flex flex-col relative">
      {/* Product Image */}
      <div className="relative p-3">
        ...
        <button
          ...
          className="absolute top-3 right-3 bg-white/90 p-2 rounded-full shadow-md transform opacity-0 -translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 ease-in-out hover:bg-red-100"
        >
          <Heart
            size={22}
      ...
      <button
        ...
        className="cursor-pointer mt-4 w-full bg-green-600 text-white py-2 px-4 rounded-xl hover:bg-green-700 transform opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 ease-in-out"
      >
        Add to Cart
      </button>
    </div>
